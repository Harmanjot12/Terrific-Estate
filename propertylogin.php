...
if(isset($_POST['submit']))
{
    ...
    $query = "Select * from propertyowner where id='$id' and password='$password'";
  ...
  <div class="container-fluid">
      <img src="logo.png" id="logo">
        <div class="btn-group btn-group-lg">
            <a href="propertysignin.php"><button type="button" class="btn btn-primary">New Account</button></a>
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <form action="propertylogin.php" method="post">
          <div class="row">
