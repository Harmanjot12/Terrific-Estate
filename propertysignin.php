...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO propertyowner
        (id,fname,lname,email,contact,state,city,street,pincode,password)     
        VALUES
        ('$id','$fname','$lname','$email','$mobile','$state','$city','$street','$pincode','$password');";
    
    $success = $db->query($query);

    if($success)
    {
    header("Location:property_homepage.php");
    $_SESSION["id"] = $id;    
    }
  ...
  <div class="container-fluid">
      <img src="logo.png" id="logo">
        <div class="btn-group btn-group-lg">
            <a href="propertylogin.php"><button type="button" class="btn btn-primary">Login</button></a>
...
<div class="container">
    <div class="row py-5 mt-4 align-items-center">
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
            <form action="propertysignin.php" method="post">
                <div class="row">
